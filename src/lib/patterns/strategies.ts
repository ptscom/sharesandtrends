...
export const STRATEGY_PRESETS: StrategyPreset[] = [
  ...
  candlePreset("inverted-hammer", "Inverted Hammer", "inverted_hammer", "Bullish reversal with long upper shadow after decline"),
  candlePreset("hanging-man", "Hanging Man", "hanging_man", "Bearish reversal hammer shape at top of trend"),
  candlePreset("bullish-harami", "Bullish Harami", "bullish_harami", "Small bullish candle inside prior bearish body"),
  candlePreset("bearish-harami", "Bearish Harami", "bearish_harami", "Small bearish candle inside prior bullish body"),
  candlePreset("bullish-kicker", "Bullish Kicker", "bullish_kicker", "Strong gap-up bullish reversal"),
  candlePreset("bearish-kicker", "Bearish Kicker", "bearish_kicker", "Strong gap-down bearish reversal"),
  candlePreset("dragonfly-doji", "Dragonfly Doji", "dragonfly_doji", "Doji with long lower tail — bullish reversal"),
  candlePreset("gravestone-doji", "Gravestone Doji", "gravestone_doji", "Doji with long upper tail — bearish reversal"),
  candlePreset("three-inside-up", "Three Inside Up", "three_inside_up", "Harami followed by bullish breakout"),
  candlePreset("three-inside-down", "Three Inside Down", "three_inside_down", "Harami followed by bearish breakdown"),
  candlePreset("abandoned-baby-bull", "Abandoned Baby (Bull)", "abandoned_baby_bull", "Gapped doji star with bullish follow-through"),
  candlePreset("abandoned-baby-bear", "Abandoned Baby (Bear)", "abandoned_baby_bear", "Gapped doji star with bearish follow-through"),
  candlePreset("rising-three-methods", "Rising Three Methods", "rising_three_methods", "Bullish continuation after brief pullback"),
  candlePreset("falling-three-methods", "Falling Three Methods", "falling_three_methods", "Bearish continuation after brief bounce"),
  candlePreset("bullish-belt-hold", "Bullish Belt Hold", "bullish_belt_hold", "Opens on low and closes strong bullish"),
  candlePreset("bearish-belt-hold", "Bearish Belt Hold", "bearish_belt_hold", "Opens on high and closes strong bearish"),
  candlePreset("advance-block", "Advance Block", "advance_block", "Weakening three-bar bullish advance — bearish warning"),
  candlePreset("upside-gap-two-crows", "Upside Gap Two Crows", "upside_gap_two_crows", "Bearish reversal after upside gap"),
];
